            ...
            resources: {
                ko: {
                    translation: {
                        ...
                        pricing_plans_plan2_description3_more: "특정 대학에서 필요한 서류들을 쉽게 관리할 수 있도록 체크리스트 형태로 제공합니다. 에세이 등 문서 작성을 위한 꿀팁및 예시를 제공하고, 일정과 비용, 장학금, 절차 등을 안내합니다. 자기소개서 및 학업계획서 조언 및 1회 첨삭을 지원합니다.",
                        ...
                        pricing_plans_plan3_description3_more: "특정 대학에서 필요한 서류들을 쉽게 관리할 수 있도록 체크리스트 형태로 제공합니다. 에세이 등 문서 작성을 위한 꿀팁및 예시를 제공하고, 일정과 비용, 장학금, 절차 등을 안내합니다. 자기소개서 및 학업계획서 조언 및 1회 첨삭을 지원합니다.",
                        ...
                        pricing_plans_plan5_description3_more: "특정 대학에서 필요한 서류들을 쉽게 관리할 수 있도록 체크리스트 형태로 제공합니다. 에세이 등 문서 작성을 위한 꿀팁및 예시를 제공하고, 일정과 비용, 장학금, 절차 등을 안내합니다. 자기소개서 및 학업계획서 개요 작성을 지원합니다. (2회 첨삭 및 문법/어휘 수정)",
                ...
                ru: {
                    translation: {
                        ...
                        pricing_plans_plan2_description3_more: "Предоставляется чек-лист необходимых документов для каждого университета. Также даются советы и примеры для написания эссе, информация о сроках и стоимости подачи документов. Поддержка в написании мотивационного письма и его редактирование (1 раз).",
                        ...
                        pricing_plans_plan3_description3_more: "Предоставляется чек-лист необходимых документов для каждого университета. Также даются советы и примеры для написания эссе, информация о сроках и стоимости подачи документов. Поддержка в написании мотивационного письма и его редактирование (1 раз).",
                        ...
                        pricing_plans_plan5_description3_more: "Предоставляется чек-лист необходимых документов для каждого университета. Также даются советы и примеры для написания эссе, информация о сроках и стоимости подачи документов. Поддержка в составлении мотивационного письма и плана обучения (2 редакции с исправлением грамматики и лексики).",
