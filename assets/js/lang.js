            ...
            resources: {
                ko: {
                    translation: {
                        ...
                        pricing_plans_plan1_description1: "1개 대학교 선정",
                        pricing_plans_plan1_description2: "서류 준비",
                        pricing_plans_plan1_description3: "대학 담당자와의 소통",
                        pricing_plans_plan1_description4: "1회 ZOOM 상담",
                        pricing_plans_plan1_description5: "교통 정보 제공",
                        pricing_plans_plan1_description6: "가이드 제공",
                        pricing_plans_plan1_description7: "한국 도착 후 유학생들과 네트워킹 지원",
                        pricing_plans_plan1_description8: "자체 장학금 제도",
                        pricing_plans_plan1_btn: "무료 상담받기",
                        pricing_plans_plan1_description1_more: "상대방의 전공이나 생활하고 싶은 지역 등을 고려하여 가장 적합한 하나의 대학교를 선정합니다.",
                        pricing_plans_plan1_description2_more: "특정 대학에서 필요한 서류들을 쉽게 관리할 수 있도록 체크리스트 형태로 제공합니다. 에세이 등 문서 작성을 위한 꿀팁을 제공하고, 1회 부분 첨삭을 지원합니다.",
                        pricing_plans_plan1_description3_more: "기본적인 행정 업무를 담당합니다.\n구체적으로 다음과 같은 업무를 수행합니다.\n\n1. 입학에 필요한 서류 패키지를 대학에 발송\n2. 등록금 납부를 위한 인보이스(invoice) 요청 및 수령\n3. 등록금 납부 완료 후, 영수증을 대학에 전달\n4. 초청장(입학허가서) 요청 및 수령\n5. 학생의 항공편 정보를 제공\n6. 필요한 경우, 대학교 관계자에게 추가 정보 요청",
                        pricing_plans_plan1_description4_more: "결제 전 무료 ZOOM 상담, 결제 후 1회 추가로 유료 ZOOM 상담을 제공합니다.",
                        pricing_plans_plan1_description5_more: "공항에서 대학 캠퍼스까지 대중교통을 이용하여 가는 방법과 택시를 타고 쉽게 이동하는 방법을 안내드립니다.",
                        pricing_plans_plan1_description6_more: "한국에서 생활하기 위한 첫걸음을 안내합니다. 비자 관련 안내, 공항에서 SIM 구매 방법, 외국인 등록증 신청, 휴대폰 개통, 인출 계좌 개설, 기타 생활 관련 팁 등을 제공합니다.",
                        pricing_plans_plan1_description7_more: "교류할 수 있는 단체 카톡방, 오프라인 정기 모임 등 현지 유학생들과 친해지고 정보를 공유하는 시간을 가지는 등 네트워킹을 지원합니다.",
                        pricing_plans_plan1_description8_more: "코리아나샤 유학원에서 우수한 학생을 추천 받고, 선발하여 학업 장려금을 제공합니다.",

                        pricing_plans_plan2_title: "올인원 플랜",
                        pricing_plans_plan2_subtitle: "어학원, 학사 과정, 석사 과정",
                        pricing_plans_plan2_description1: "3개 대학교 선정",
                        pricing_plans_plan2_description2: "서류 준비",
                        pricing_plans_plan2_description3: "대학 담당자와의 소통",
                        pricing_plans_plan2_description4: "3회 ZOOM 상담",
                        pricing_plans_plan2_description5: "교통 정보 제공",
                        pricing_plans_plan2_description6: "가이드 제공",
                        pricing_plans_plan2_description7: "비자 취득 지원",
                        pricing_plans_plan2_description8: "기숙사 신청 혹은 숙소 탐색 지원",
                        pricing_plans_plan2_description9: "한국 도착 후 유학생들과 네트워킹 지원",
                        pricing_plans_plan2_description10: "자체 장학금 제도",
                        pricing_plans_plan2_btn: "무료 상담받기",
                        pricing_plans_plan2_description1_more: "상대방의 전공이나 생활하고 싶은 지역 등을 고려하여 적합한 3개의 대학교 옵션을 선정하고, 필요에 따라 1~3개 대학에 입학을 신청합니다.",
                        pricing_plans_plan2_description2_more: "특정 대학에서 필요한 서류들을 쉽게 관리할 수 있도록 체크리스트 형태로 제공합니다. 에세이 등 문서 작성을 위한 꿀팁을 제공하고, 학생의 정보를 기반으로 개요 작성 및 2회 부분 첨삭을 지원합니다.",
                        pricing_plans_plan2_description3_more: "기본적인 행정 업무를 담당합니다.\n구체적으로 다음과 같은 업무를 수행합니다.\n\n1. 입학에 필요한 서류 패키지를 대학에 발송\n2. 등록금 납부를 위한 인보이스(invoice) 요청 및 수령\n3. 등록금 납부 완료 후, 영수증을 대학에 전달\n4. 초청장(입학허가서) 요청 및 수령\n5. 학생의 항공편 정보를 제공\n6. 필요한 경우, 대학교 관계자에게 추가 정보 요청",
                        pricing_plans_plan2_description4_more: "결제 전 무료 ZOOM 상담, 결제 후 3회 추가로 유료 ZOOM 상담을 제공합니다.",
                        pricing_plans_plan2_description5_more: "공항에서 대학 캠퍼스까지 대중교통을 이용하여 가는 방법과 택시를 타고 쉽게 이동하는 방법을 안내드립니다.",
                        pricing_plans_plan2_description6_more: "한국에서 생활하기 위한 첫걸음을 안내합니다. 비자 관련 안내, 공항에서 SIM 구매 방법, 외국인 등록증 신청, 휴대폰 개통, 인출 계좌 개설, 기타 생활 관련 팁 등을 제공합니다.",
                        pricing_plans_plan2_description7_more: "신청 서류 준비, 신청서 작성 방법 및 예시, 처리 기간, 건강진단서 작성 방법 등 비자 취득에 관한 상세한 정보를 제공하고 문제없이 신청할 수 있도록 지원해줍니다.",
                        pricing_plans_plan2_description8_more: "기숙사에 살고자 한다면 학생 정보를 기입하고 기숙사 신청을 지원하고, 자취를 원하면 온라인으로 숙소 탐색을 지원합니다.",
                        pricing_plans_plan2_description9_more: "교류할 수 있는 단체 카톡방, 오프라인 정기 모임 등 현지 유학생들과 친해지고 정보를 공유하는 시간을 가지는 등 네트워킹을 지원합니다.",
                        pricing_plans_plan2_description10_more: "코리아나샤 유학원에서 우수한 학생을 추천 받고, 선발하여 학업 장려금을 제공합니다.",

                        pricing_plans_plan3_subtitle: "최대할인",
                        pricing_plans_plan3_title: "프리미엄 플랜",
                        pricing_plans_plan3_description: "어학원, 학사 과정, 석사 과정",
                        pricing_plans_plan3_description1: "3개 대학교 선정",
                        pricing_plans_plan3_description2: "서류 준비",
                        pricing_plans_plan3_description3: "대학 담당자와의 소통",
                        pricing_plans_plan3_description4: "2회 ZOOM 상담",
                        pricing_plans_plan3_description5: "교통 정보 제공",
                        pricing_plans_plan3_description6: "가이드 제공",
                        pricing_plans_plan3_description7: "비자 취득에 관한 상세한 정보 제공",
                        pricing_plans_plan3_description8: "기숙사 신청 혹은 숙소 탐색 지원",
                        pricing_plans_plan3_description9: "한국 도착 후 유학생들과 네트워킹 지원",
                        pricing_plans_plan3_description10: "자체 장학금 제도",
                        pricing_plans_plan3_btn: "무료 상담받기",
                        pricing_plans_plan3_description1_more: "상대방의 전공이나 생활하고 싶은 지역 등을 고려하여 적합한 3개의 대학교 옵션을 선정하고, 필요에 따라 1~3개 대학에 입학을 신청합니다.",
                        pricing_plans_plan3_description2_more: "특정 대학에서 필요한 서류들을 쉽게 관리할 수 있도록 체크리스트 형태로 제공합니다. 에세이 등 문서 작성을 위한 꿀팁을 제공하고, 1회 부분 첨삭을 지원합니다.",
                        pricing_plans_plan3_description3_more: "기본적인 행정 업무를 담당합니다.\n구체적으로 다음과 같은 업무를 수행합니다.\n\n1. 입학에 필요한 서류 패키지를 대학에 발송\n2. 등록금 납부를 위한 인보이스(invoice) 요청 및 수령\n3. 등록금 납부 완료 후, 영수증을 대학에 전달\n4. 초청장(입학허가서) 요청 및 수령\n5. 학생의 항공편 정보를 제공\n6. 필요한 경우, 대학교 관계자에게 추가 정보 요청",
                        pricing_plans_plan3_description4_more: "결제 전 무료 ZOOM 상담, 결제 후 2회 추가로 유료 ZOOM 상담을 제공합니다.",
                        pricing_plans_plan3_description5_more: "공항에서 대학 캠퍼스까지 대중교통을 이용하여 가는 방법과 택시를 타고 쉽게 이동하는 방법을 안내드립니다.",
                        pricing_plans_plan3_description6_more: "한국에서 생활하기 위한 첫걸음을 안내합니다. 비자 관련 안내, 공항에서 SIM 구매 방법, 외국인 등록증 신청, 휴대폰 개통, 인출 계좌 개설, 기타 생활 관련 팁 등을 제공합니다.",
                        pricing_plans_plan3_description7_more: "신청 서류 준비, 신청서 작성 방법 및 예시, 처리 기간, 건강진단서 작성 방법 등 비자 취득에 관한 상세한 정보를 제공합니다.",
                        pricing_plans_plan3_description8_more: "기숙사에 살고자 한다면 학생 정보를 기입하고 기숙사 신청을 지원하고, 자취를 원하면 온라인으로 숙소 탐색을 지원합니다.",
                        pricing_plans_plan3_description9_more: "교류할 수 있는 단체 카톡방, 오프라인 정기 모임 등 현지 유학생들과 친해지고 정보를 공유하는 시간을 가지는 등 네트워킹을 지원합니다.",
                        pricing_plans_plan3_description10_more: "코리아나샤 유학원에서 우수한 학생을 추천 받고, 선발하여 학업 장려금을 제공합니다.",
                ...
                ru: {
                    translation: {
                        ...
                        pricing_plans_plan1_description1: "Подбор университета, подходящего вам",
                        pricing_plans_plan1_description2: "Помощь в подготовке документов",
                        pricing_plans_plan1_description3: "Общение с представителями университета",
                        pricing_plans_plan1_description4: "Одна консультация в ZOOM",
                        pricing_plans_plan1_description5: "Информация о транспорте в Корее",
                        pricing_plans_plan1_description6: "Гид и поддержка на месте",
                        pricing_plans_plan1_description7: "Помощь в знакомстве с другими студентами",
                        pricing_plans_plan1_description8: "Возможность получить стипендию",
                        pricing_plans_plan1_btn: "Бесплатная консультация",
                        pricing_plans_plan1_description1_more: "Мы подбираем один университет, который наилучшим образом соответствует вашему профилю, учитывая вашу специальность и предпочтительное место проживания.",  
                        pricing_plans_plan1_description2_more: "Мы предоставляем удобный чек-лист со всеми необходимыми документами для поступления. Также делимся полезными советами по написанию эссе и предоставляем одну бесплатную проверку документов.",  
                        pricing_plans_plan1_description3_more: "Мы занимаемся основными административными процессами:\n\n1. Отправка пакета документов в университет\n2. Запрос и получение инвойса для оплаты обучения\n3. Передача квитанции об оплате в университет\n4. Запрос и получение приглашения (письма о зачислении)\n5. Предоставление информации о рейсе студента\n6. Запрос дополнительной информации у университета при необходимости.",  
                        pricing_plans_plan1_description4_more: "Перед оплатой мы предлагаем бесплатную консультацию по ZOOM. После оплаты предоставляется еще одна дополнительная платная консультация.",  
                        pricing_plans_plan1_description5_more: "Мы расскажем, как добраться из аэропорта до университета на общественном транспорте или такси наиболее удобным способом.",  
                        pricing_plans_plan1_description6_more: "Мы помогаем вам сделать первые шаги в Корее: рассказываем о визе, покупке SIM-карты, регистрации иностранца, подключении мобильного телефона, открытии банковского счета и других аспектах повседневной жизни.",  
                        pricing_plans_plan1_description7_more: "Мы организуем общение с другими студентами через групповые чаты, регулярные офлайн-встречи и другие мероприятия, чтобы помочь вам быстрее адаптироваться.",  
                        pricing_plans_plan1_description8_more: "Образовательное агентство Koreanasha отбирает и рекомендует лучших студентов для получения стипендии, поддерживающей их учебу.",  
                        ...
                        pricing_plans_plan2_description1: "Подбор трех университетов, подходящих вам",  
                        pricing_plans_plan2_description2: "Помощь в подготовке документов",  
                        pricing_plans_plan2_description3: "Общение с представителями университета",  
                        pricing_plans_plan2_description4: "Три консультации в ZOOM",  
                        pricing_plans_plan2_description5: "Информация о транспорте в Корее",  
                        pricing_plans_plan2_description6: "Гид и поддержка на месте",  
                        pricing_plans_plan2_description7: "Помощь в получении визы",  
                        pricing_plans_plan2_description8: "Поддержка в подаче заявки на общежитие или поиске жилья",  
                        pricing_plans_plan2_description9: "Помощь в знакомстве с другими студентами",  
                        pricing_plans_plan2_description10: "Возможность получить стипендию",
                        pricing_plans_plan2_btn: "Бесплатная консультация",
                        pricing_plans_plan2_description1_more: "Мы подбираем три университета, подходящих вам, с учетом вашей специальности и предпочтений по месту жительства. При необходимости подаем заявки в 1–3 университета.",  
                        pricing_plans_plan2_description2_more: "Мы предоставляем удобный чек-лист со всеми необходимыми документами. Также помогаем с написанием эссе, составляем черновик на основе ваших данных и предоставляем две бесплатные проверки документов.",  
                        pricing_plans_plan2_description3_more: "Мы занимаемся основными административными процессами:\n\n1. Отправка пакета документов в университет\n2. Запрос и получение инвойса для оплаты обучения\n3. Передача квитанции об оплате в университет\n4. Запрос и получение приглашения (письма о зачислении)\n5. Предоставление информации о рейсе студента\n6. Запрос дополнительной информации у университета при необходимости.",  
                        pricing_plans_plan2_description4_more: "Перед оплатой мы предлагаем бесплатную консультацию по ZOOM. После оплаты предоставляются еще три дополнительные платные консультации.",  
                        pricing_plans_plan2_description5_more: "Мы расскажем, как добраться из аэропорта до университета на общественном транспорте или такси наиболее удобным способом.",  
                        pricing_plans_plan2_description6_more: "Мы помогаем вам сделать первые шаги в Корее: рассказываем о визе, покупке SIM-карты, регистрации иностранца, подключении мобильного телефона, открытии банковского счета и других аспектах повседневной жизни.",  
                        pricing_plans_plan2_description7_more: "Мы подробно расскажем о процессе получения визы: подготовка документов, заполнение анкеты, сроки рассмотрения, медицинская справка и другие важные моменты.",  
                        pricing_plans_plan2_description8_more: "Мы помогаем вам подать заявку на общежитие или найти жилье для самостоятельного проживания через онлайн-платформы.",  
                        pricing_plans_plan2_description9_more: "Мы организуем общение с другими студентами через групповые чаты, регулярные офлайн-встречи и другие мероприятия, чтобы помочь вам быстрее адаптироваться.",  
                        pricing_plans_plan2_description10_more: "Образовательное агентство Koreanasha отбирает и рекомендует лучших студентов для получения стипендии, поддерживающей их учебу.",  
                        ...
                        pricing_plans_plan3_description1: "Подбор трех университетов, подходящих вам",  
                        pricing_plans_plan3_description2: "Помощь в подготовке документов",  
                        pricing_plans_plan3_description3: "Общение с представителями университета",  
                        pricing_plans_plan3_description4: "Две консультации в ZOOM",  
                        pricing_plans_plan3_description5: "Информация о транспорте в Корее",  
                        pricing_plans_plan3_description6: "Гид и поддержка на месте",  
                        pricing_plans_plan3_description7: "Информация о получении визы",  
                        pricing_plans_plan3_description8: "Поддержка в подаче заявки на общежитие или поиске жилья",  
                        pricing_plans_plan3_description9: "Помощь в знакомстве с другими студентами",  
                        pricing_plans_plan3_description10: "Возможность получить стипендию",  
                        pricing_plans_plan3_btn: "Бесплатная консультация",
                        pricing_plans_plan3_description1_more: "Мы подбираем три университета, подходящих вам, с учетом вашей специальности и предпочтений по месту жительства. При необходимости подаем заявки в 1–3 университета.",  
                        pricing_plans_plan3_description2_more: "Мы предоставляем удобный чек-лист со всеми необходимыми документами. Также делимся полезными советами по написанию эссе и предоставляем одну бесплатную проверку документов.",  
                        pricing_plans_plan3_description3_more: "Мы занимаемся основными административными процессами:\n\n1. Отправка пакета документов в университет\n2. Запрос и получение инвойса для оплаты обучения\n3. Передача квитанции об оплате в университет\n4. Запрос и получение приглашения (письма о зачислении)\n5. Предоставление информации о рейсе студента\n6. Запрос дополнительной информации у университета при необходимости.",  
                        pricing_plans_plan3_description4_more: "Перед оплатой мы предлагаем бесплатную консультацию по ZOOM. После оплаты предоставляются еще две дополнительные платные консультации.",  
                        pricing_plans_plan3_description5_more: "Мы расскажем, как добраться из аэропорта до университета на общественном транспорте или такси наиболее удобным способом.",  
                        pricing_plans_plan3_description6_more: "Мы помогаем вам сделать первые шаги в Корее: рассказываем о визе, покупке SIM-карты, регистрации иностранца, подключении мобильного телефона, открытии банковского счета и других аспектах повседневной жизни.",  
                        pricing_plans_plan3_description7_more: "Мы предоставляем информацию о процессе получения визы: подготовка документов, заполнение анкеты, сроки рассмотрения, медицинская справка и другие важные моменты.",  
                        pricing_plans_plan3_description8_more: "Мы помогаем вам подать заявку на общежитие или найти жилье для самостоятельного проживания через онлайн-платформы.",  
                        pricing_plans_plan3_description9_more: "Мы организуем общение с другими студентами через групповые чаты, регулярные офлайн-встречи и другие мероприятия, чтобы помочь вам быстрее адаптироваться.",  
                        pricing_plans_plan3_description10_more: "Образовательное агентство Koreanasha отбирает и рекомендует лучших студентов для получения стипендии, поддерживающей их учебу.",  
