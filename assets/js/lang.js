            ...
            resources: {
                ko: {
                    translation: {
                        ...
                        banner_description: "당신의 꿈을 현실로 만들어 드립니다.<br>한국 유학의 첫걸음, 지금 바로 시작하세요!",
                        banner_btn: "상담 신청",
                        banner_btn_only_mobile: "상담 신청",
                        ...
                        pricing_plans_description: "한국 대학 입학을 꿈꾸는 여러분을 위해 다양한 요금제를 준비했습니다.",

                        pills_plan_category_1_tab: "한국 대학 입학",
                        pills_plan_category_2_tab: "VVIP 플랜",
                        pills_plan_category_3_tab: "추가 구매 옵션",
                        pills_plan_category_4_tab: "단기 어학 연수",

                        pricing_plans_plan1_title: "베이직 플랜",
                        pricing_plans_plan1_subtitle: "어학원 기준이며,<br>학사/석사 과정은 $40 추가됩니다.",
                        pricing_plans_plan1_description1: "초기 상담(30분)",
                        pricing_plans_plan1_description2: "3개 대학교 추천",
                        pricing_plans_plan1_description3: "서류 준비",
                        pricing_plans_plan1_description4: "대학 담당자와의 소통",
                        pricing_plans_plan1_description5: "모니터링 및 알림, 주 5일 멘토와 채팅 지원",
                        pricing_plans_plan1_description6: "온라인 지원 과정 가이드 제공",
                        pricing_plans_plan1_description7: "교통 정보 제공",
                        pricing_plans_plan1_description8: "한국 생활 가이드 제공",
                        pricing_plans_plan1_description9: "한국 도착 후 유학생들과 네트워킹 지원",
                        pricing_plans_plan1_description10: "자체 장학금 제도",
                        pricing_plans_plan1_btn: "상담 신청",
                        pricing_plans_plan1_description1_more: "30분 음성/화상 상담을 제공합니다. 전체적인 진행 과정을 알려주고 학생 맞춤형으로 지도할 수 있도록 질문을 주고 받습니다.",
                        pricing_plans_plan1_description2_more: "상대방의 전공이나 생활하고 싶은 지역 등을 고려하여 3개의 대학을 추천하고 가장 적합한 하나의 대학교를 선정합니다. (2개 이상 지원 시 대학당 $50 추가)",
                        pricing_plans_plan1_description3_more: "특정 대학에서 필요한 서류들을 쉽게 관리할 수 있도록 체크리스트 형태로 제공합니다. 에세이 등 문서 작성을 위한 꿀팁 및 예시를 제공하고, 일정과 비용 절차 등을 안내합니다.",
                        pricing_plans_plan1_description4_more: "대학 입학처와의 연락을 지원하고, 전화 문의를 대행합니다.",
                        pricing_plans_plan1_description5_more: "서류 제출 등 일정을 모니터링하고 알려줍니다. 그리고 주 5일 멘토와 채팅을 지원합니다.",
                        pricing_plans_plan1_description6_more: "온라인 지원 과정 절차 및 방법을 안내합니다.",
                        pricing_plans_plan1_description7_more: "네이버지도/카카오맵 설치 및 사용 방법, 카카오택시 설치 및 사용 방법을 안내합니다.",
                        pricing_plans_plan1_description8_more: "한국에서 생활하기 위한 첫걸음을 안내합니다. 공항에서 SIM 구매 방법, 외국인 등록증 신청, 휴대폰 개통, 인출 계좌 개설, 기타 생활 관련 팁 등을 제공합니다.",
                        pricing_plans_plan1_description9_more: "교류할 수 있는 단체 카톡방, 오프라인 정기 모임 등 현지 유학생들과 친해지고 정보를 공유하는 시간을 가지는 등 네트워킹을 지원합니다.",
                        pricing_plans_plan1_description10_more: "Koreanasha 유학원에서 우수한 학생을 추천 받고, 선발하여 학업 장려금을 제공합니다.",

                        pricing_plans_plan2_title: "올인원 플랜",
                        pricing_plans_plan2_subtitle: "어학원 기준이며,<br>학사/석사 과정은 $40 추가됩니다.",
                        pricing_plans_plan2_description1: "초기 상담(90분)",
                        pricing_plans_plan2_description2: "7개 대학교 추천",
                        pricing_plans_plan2_description3: "서류 준비",
                        pricing_plans_plan2_description4: "대학 담당자와의 소통",
                        pricing_plans_plan2_description5: "모니터링 및 알림, 주 7일 멘토와 채팅 지원",
                        pricing_plans_plan2_description6: "온라인 지원 과정 전반 지원",
                        pricing_plans_plan2_description7: "학비 납부 지원, 결제 방법 안내",
                        pricing_plans_plan2_description8: "기숙사 비용 및 옵션 안내",
                        pricing_plans_plan2_description9: "비자 신청 지원",
                        pricing_plans_plan2_description10: "교통 정보 제공",
                        pricing_plans_plan2_description11: "한국 생활 가이드 제공",
                        pricing_plans_plan2_description12: "한국 도착 후 유학생들과 네트워킹 지원",
                        pricing_plans_plan2_description13: "자체 장학금 제도",
                        pricing_plans_plan2_btn: "상담 신청",
                        pricing_plans_plan2_description1_more: "90분 음성/화상 상담을 제공합니다. 전체적인 진행 과정을 알려주고 학생 맞춤형으로 지도할 수 있도록 질문을 주고 받습니다.",
                        pricing_plans_plan2_description2_more: "상대방의 전공이나 생활하고 싶은 지역 등을 고려하여 7개의 대학을 추천하고 가장 적합한 하나의 대학교를 선정합니다. (2개 이상 지원 시 대학당 $50 추가)",
                        pricing_plans_plan2_description3_more: "특정 대학에서 필요한 서류들을 쉽게 관리할 수 있도록 체크리스트 형태로 제공합니다. 에세이 등 문서 작성을 위한 꿀팁 및 예시를 제공하고, 일정과 비용, 장학금, 절차 등을 안내합니다. 자기소개서 및 학업계획서 조언 및 1회 어휘 수정/첨삭을 지원합니다.",
                        pricing_plans_plan2_description4_more: "대학 입학처와의 연락을 지원하고, 이메일 작성 및 전화 문의를 대행합니다.",
                        pricing_plans_plan2_description5_more: "서류 제출 등 일정을 모니터링하고 알려줍니다. 그리고 주 5일 멘토와 채팅을 지원합니다.",
                        pricing_plans_plan2_description6_more: "온라인 지원 과정 절차를 지원하고, 멘토가 지원서 제출 및 심사비 결제를 대행합니다.",
                        pricing_plans_plan2_description7_more: "학비 납부와 결제 방법에 대해 안내합니다.",
                        pricing_plans_plan2_description8_more: "기숙사 비용 및 옵션에 대해 안내합니다. 기숙사 배정이 어려울 경우, 학교 근처 숙소 (Airbnb 등) 5개 옵션 추천 및 예약을 대행합니다. (숙박비 선입금 필요)<br><br>※ 숙소를 보장하지는 않습니다.",
                        pricing_plans_plan2_description9_more: "비자 신청을 지원합니다. 서류 목록을 제공하고 검토합니다. 비자 발급 지연 시, 한국 내 비자 변경을 지원합니다. (서류 준비 및 출입국 관리소 방문 예약)",
                        pricing_plans_plan2_description10_more: "네이버지도/카카오맵 설치 및 사용 방법, 카카오택시 설치 및 사용 방법을 안내합니다.",
                        pricing_plans_plan2_description11_more: "한국에서 생활하기 위한 첫걸음을 안내합니다. 공항에서 SIM 구매 방법, 외국인 등록증 신청, 휴대폰 개통, 인출 계좌 개설, 기타 생활 관련 팁 등을 제공합니다.",
                        pricing_plans_plan2_description12_more: "교류할 수 있는 단체 카톡방, 오프라인 정기 모임 등 현지 유학생들과 친해지고 정보를 공유하는 시간을 가지는 등 네트워킹을 지원합니다.",
                        pricing_plans_plan2_description13_more: "Koreanasha 유학원에서 우수한 학생을 추천 받고, 선발하여 학업 장려금을 제공합니다.",

                        pricing_plans_plan3_subtitle: "최대할인",
                        pricing_plans_plan3_title: "프리미엄 플랜",
                        pricing_plans_plan3_description: "어학원 기준이며,<br>학사/석사 과정은 $40 추가됩니다.",
                        pricing_plans_plan3_description1: "초기 상담(60분)",
                        pricing_plans_plan3_description2: "5개 대학교 추천",
                        pricing_plans_plan3_description3: "서류 준비",
                        pricing_plans_plan3_description4: "대학 담당자와의 소통",
                        pricing_plans_plan3_description5: "모니터링 및 알림, 주 5일 멘토와 채팅 지원",
                        pricing_plans_plan3_description6: "온라인 지원 과정 가이드 제공",
                        pricing_plans_plan3_description7: "학비 납부 지원, 결제 방법 안내",
                        pricing_plans_plan3_description8: "기숙사 비용 및 옵션 안내",
                        pricing_plans_plan3_description9: "비자 신청 지원 (서류 목록 제공 및 검토)",
                        pricing_plans_plan3_description10: "교통 정보 제공",
                        pricing_plans_plan3_description11: "한국 생활 가이드 제공",
                        pricing_plans_plan3_description12: "한국 도착 후 유학생들과 네트워킹 지원",
                        pricing_plans_plan3_description13: "자체 장학금 제도",
                        pricing_plans_plan3_btn: "상담 신청",
                        pricing_plans_plan3_description1_more: "60분 음성/화상 상담을 제공합니다. 전체적인 진행 과정을 알려주고 학생 맞춤형으로 지도할 수 있도록 질문을 주고 받습니다.",
                        pricing_plans_plan3_description2_more: "상대방의 전공이나 생활하고 싶은 지역 등을 고려하여 5개의 대학을 추천하고 가장 적합한 하나의 대학교를 선정합니다. (2개 이상 지원 시 대학당 $50 추가)",
                        pricing_plans_plan3_description3_more: "특정 대학에서 필요한 서류들을 쉽게 관리할 수 있도록 체크리스트 형태로 제공합니다. 에세이 등 문서 작성을 위한 꿀팁을 안내하고, 일정과 비용, 장학금, 절차 등을 안내합니다. 자기소개서 및 학업계획서에 대해 조언 및 1회 첨삭을 지원합니다.",
                        pricing_plans_plan3_description4_more: "대학 입학처와의 연락을 지원하고, 전화 문의를 대행합니다.",
                        pricing_plans_plan3_description5_more: "서류 제출 등 일정을 모니터링하고 알려줍니다. 그리고 주 5일 멘토와 채팅을 지원합니다.",
                        pricing_plans_plan3_description6_more: "온라인 지원 과정 절차 및 방법을 안내합니다.",
                        pricing_plans_plan3_description7_more: "학비 납부와 결제 방법에 대해 안내합니다.",
                        pricing_plans_plan3_description8_more: "기숙사 비용 및 옵션에 대해 안내합니다.<br><br>※ 숙소를 보장하지는 않습니다.",
                        pricing_plans_plan3_description9_more: "비자 신청을 지원합니다.",
                        pricing_plans_plan3_description10_more: "네이버지도/카카오맵 설치 및 사용 방법, 카카오택시 설치 및 사용 방법을 안내합니다.",
                        pricing_plans_plan3_description11_more: "한국에서 생활하기 위한 첫걸음을 안내합니다. 공항에서 SIM 구매 방법, 외국인 등록증 신청, 휴대폰 개통, 인출 계좌 개설, 기타 생활 관련 팁 등을 제공합니다.",
                        pricing_plans_plan3_description12_more: "교류할 수 있는 단체 카톡방, 오프라인 정기 모임 등 현지 유학생들과 친해지고 정보를 공유하는 시간을 가지는 등 네트워킹을 지원합니다.",
                        pricing_plans_plan3_description13_more: "Koreanasha 유학원에서 우수한 학생을 추천 받고, 선발하여 학업 장려금을 제공합니다.",
                        ...
                        pricing_plans_plan4_btn: "상담 신청",
                        pricing_plans_plan4_description1_more: "-",
                        pricing_plans_plan4_description2_more: "-",
                        pricing_plans_plan4_description3_more: "-",
                        pricing_plans_plan4_description4_more: "-",

                        pricing_plans_plan5_title: "VVIP 플랜",
                        pricing_plans_plan5_subtitle: "어학원 기준이며,<br>학사/석사 과정은 $100 추가됩니다.",
                        pricing_plans_plan5_description1: "초기 상담(시간 제한 없음)",
                        pricing_plans_plan5_description2: "모든 적합한 대학교 추천",
                        pricing_plans_plan5_description3: "서류 준비",
                        pricing_plans_plan5_description4: "대학 담당자와의 소통",
                        pricing_plans_plan5_description5: "모니터링 및 알림, 주 7일 멘토와 채팅 & 통화 지원",
                        pricing_plans_plan5_description6: "온라인 지원 과정 전반 지원",
                        pricing_plans_plan5_description7: "학비 납부 대행",
                        pricing_plans_plan5_description8: "기숙사 비용 및 옵션 안내",
                        pricing_plans_plan5_description9: "비자 신청 지원",
                        pricing_plans_plan5_description10: "교통 정보 제공",
                        pricing_plans_plan5_description11: "한국 생활 가이드 제공",
                        pricing_plans_plan5_description12: "한국 도착 후 유학생들과 네트워킹 지원",
                        pricing_plans_plan5_description13: "자체 장학금 제도",
                        pricing_plans_plan5_btn: "상담 신청",
                        pricing_plans_plan5_description1_more: "시간 제한 없이 음성/화상 상담을 제공합니다. 전체적인 진행 과정을 알려주고 학생 맞춤형으로 지도할 수 있도록 질문을 주고 받습니다.",
                        pricing_plans_plan5_description2_more: "상대방의 전공이나 생활하고 싶은 지역 등을 고려하여 모든 대학을 추천하고 가장 적합한 하나의 대학교를 선정합니다. (2개 이상 지원 시 대학당 $50 추가)",
                        pricing_plans_plan5_description3_more: "특정 대학에서 필요한 서류들을 쉽게 관리할 수 있도록 체크리스트 형태로 제공합니다. 에세이 등 문서 작성을 위한 꿀팁 및 예시를 제공하고, 일정과 비용, 장학금, 절차 등을 안내합니다. 자기소개서 및 학업계획서 개요 작성을 지원합니다. (문법/어휘 수정 및 무제한 첨삭)",
                        pricing_plans_plan5_description4_more: "대학 입학처와의 연락을 지원하고, 학생 명의 이메일 생성 후 직접 이메일 작성 문의 및 전화 문의를 대행합니다.",
                        pricing_plans_plan5_description5_more: "서류 제출 등 일정을 모니터링하고 알려줍니다. 그리고 주 5일 멘토와 채팅 & 통화를 지원합니다. (1시간 내 답변 보장)",
                        pricing_plans_plan5_description6_more: "온라인 지원 과정 절차를 지원하고, 멘토가 지원서 제출 및 심사비 결제를 대행합니다.",
                        pricing_plans_plan5_description7_more: "학비 납부를 대행합니다. (학생이 사전에 멘토 계좌로 송금해야 함)",
                        pricing_plans_plan5_description8_more: "기숙사 비용 및 옵션에 대해 안내합니다. 기숙사 배정이 어려울 경우, 학교 근처 숙소 (Airbnb 등) 무제한 추천 및 예약을 대행합니다. (숙박비 선입금 필요)<br><br>※ 숙소를 보장하지는 않습니다.",
                        pricing_plans_plan5_description9_more: "비자 신청을 지원합니다. 서류 목록을 제공하고 검토합니다. 비자 발급 지연 시, 한국 내 비자 변경을 지원합니다. (서류 준비 및 출입국 관리소 방문 예약)",
                        pricing_plans_plan5_description10_more: "네이버지도/카카오맵 설치 및 사용 방법, 카카오택시 설치 및 사용 방법을 안내합니다.",
                        pricing_plans_plan5_description11_more: "한국에서 생활하기 위한 첫걸음을 안내합니다. 공항에서 SIM 구매 방법, 외국인 등록증 신청, 휴대폰 개통, 인출 계좌 개설, 기타 생활 관련 팁 등을 제공합니다. 뿐만 아니라 입학 후 3개월간 생활 상담을 지원합니다.",
                        pricing_plans_plan5_description12_more: "교류할 수 있는 단체 카톡방, 오프라인 정기 모임 등 현지 유학생들과 친해지고 정보를 공유하는 시간을 가지는 등 네트워킹을 지원합니다.",
                        pricing_plans_plan5_description13_more: "Koreanasha 유학원에서 우수한 학생을 추천 받고, 선발하여 학업 장려금을 제공합니다.",

                        pricing_plans_plan6_title: "공항 픽업 및 캠퍼스 투어",
                        pricing_plans_plan6_subtitle: "서울 캠퍼스 한정",
                        pricing_plans_plan6_description1: "공항 픽업",
                        pricing_plans_plan6_description2: "캠퍼스 투어",
                        pricing_plans_plan6_btn: "상담 신청",
                        pricing_plans_plan6_description1_more: "공항에 도착하면 픽업하여 캠퍼스로 이동합니다. (택시비 별도 부담)",
                        pricing_plans_plan6_description2_more: "캠퍼스 유명 장소 등 전반적인 투어를 진행합니다.",

                        pricing_plans_plan7_title: "자취방 탐색",
                        pricing_plans_plan7_subtitle: "서울 및 경기권 한정",
                        pricing_plans_plan7_description1: "온라인 매물 탐색",
                        pricing_plans_plan7_description2: "오프라인 매물 탐색",
                        pricing_plans_plan7_btn: "상담 신청",
                        pricing_plans_plan7_description1_more: "온라인으로 가격적으로, 심미적으로 적합한 집을 찾아 보내드립니다.",
                        pricing_plans_plan7_description2_more: "러시아어를 사용하는 협력사를 통해 오프라인으로 직접 매물을 찾아드립니다.",
                        ...
                        modal_title: "상담글을 작성하고<br>한국대학 컨설팅을 받아보세요.",
                ...
                ru: {
                    translation: {
                        ...
                        banner_description: "Поможем воплотить ваши мечты в реальность.<br>Начните прямо сейчас!",
                        banner_btn: "Заявка",
                        banner_btn_only_mobile: "Заявка",
                        ...
                        pricing_plans_description: "Для тех, кто мечтает поступить в корейский университет, мы подготовили различные тарифные планы, которые соответствуют вашим потребностям.",
                        ...
                        pricing_plans_plan1_subtitle: "Основано на языковой школе.<br>Для бакалавриата/магистратуры доплата $40.",
                        pricing_plans_plan1_description1: "Первичная консультация (30 минут)",
                        pricing_plans_plan1_description2: "Рекомендация 3 университетов",
                        pricing_plans_plan1_description3: "Подготовка документов",
                        pricing_plans_plan1_description4: "Связь с представителями университетов",
                        pricing_plans_plan1_description5: "Мониторинг и уведомления, поддержка в чате 5 дней в неделю",
                        pricing_plans_plan1_description6: "Предоставление гида по онлайн-заявке",
                        pricing_plans_plan1_description7: "Предоставление информации о транспорте",
                        pricing_plans_plan1_description8: "Гид по жизни в Корее",
                        pricing_plans_plan1_description9: "Поддержка в нетворкинге с другими студентами по прибытии в Корею",
                        pricing_plans_plan1_description10: "Собственная система стипендий",
                        pricing_plans_plan1_btn: "Заявка",
                        pricing_plans_plan1_description1_more: "Предоставляется 30-минутная консультация (аудио/видео). Объясняется весь процесс поступления, обсуждаются вопросы и даются персонализированные рекомендации.",
                        pricing_plans_plan1_description2_more: "Мы подбираем 3 университета с учетом вашей специальности и предпочтений по месту проживания, после чего выбираем самый подходящий. (При подаче более чем в 2 университета доплата $50 за каждый).",
                        pricing_plans_plan1_description3_more: "Предоставляется чек-лист необходимых документов для каждого университета. Также даются советы и примеры для написания эссе, информация о сроках и стоимости подачи документов.",
                        pricing_plans_plan1_description4_more: "Оказываем поддержку при связи с приемными комиссиями университетов и звоним от вашего имени.",
                        pricing_plans_plan1_description5_more: "Мониторинг сроков подачи документов и уведомления. Поддержка в чате с ментором 5 дней в неделю.",
                        pricing_plans_plan1_description6_more: "Разъясняем процедуру подачи онлайн-заявки.",
                        pricing_plans_plan1_description7_more: "Объясняем установку и использование Naver Maps, Kakao Maps и Kakao Taxi.",
                        pricing_plans_plan1_description8_more: "Гид по первой адаптации в Корее: покупка SIM-карты в аэропорту, регистрация иностранца, оформление банковского счета и другие важные советы по жизни.",
                        pricing_plans_plan1_description9_more: "Помощь в знакомстве с другими иностранными студентами: чаты, регулярные встречи и обмен информацией.",
                        ...
                        pricing_plans_plan2_description2: "Рекомендация 7 университетов",
                        pricing_plans_plan2_description3: "Подготовка документов",
                        pricing_plans_plan2_description4: "Связь с представителями университетов",
                        pricing_plans_plan2_description5: "Мониторинг и уведомления, поддержка в чате 7 дней в неделю",
                        pricing_plans_plan2_description6: "Полная поддержка в процессе подачи онлайн-заявки",
                        pricing_plans_plan2_description7: "Помощь в оплате обучения и консультация по способам оплаты",
                        pricing_plans_plan2_description8: "Консультация по стоимости и вариантам проживания",
                        pricing_plans_plan2_description9: "Поддержка в подаче на визу",
                        pricing_plans_plan2_description10: "Предоставление информации о транспорте",
                        pricing_plans_plan2_description11: "Гид по жизни в Корее",
                        pricing_plans_plan2_description12: "Поддержка в нетворкинге с другими студентами по прибытии в Корею",
                        pricing_plans_plan2_description13: "Собственная система стипендий",
                        pricing_plans_plan2_btn: "Заявка",
                        pricing_plans_plan2_description1_more: "Предоставляется 90-минутная консультация (аудио/видео). Объясняется весь процесс поступления, обсуждаются вопросы и даются персонализированные рекомендации.",
                        pricing_plans_plan2_description2_more: "Мы подбираем 7 университетов с учетом вашей специальности и предпочтений по месту проживания, после чего выбираем самый подходящий. (При подаче более чем в 2 университета доплата $50 за каждый).",
                        pricing_plans_plan2_description3_more: "Мы предоставляем чек-лист для удобного управления необходимыми документами для поступления в определённый университет. Также предлагаем полезные советы и примеры для написания эссе и других документов, информируем о сроках, стоимости, стипендиях и процессе поступления. Оказываем поддержку в написании мотивационного письма и учебного плана, а также предлагаем одну редакцию с коррекцией лексики.",
                        pricing_plans_plan2_description4_more: "Оказываем поддержку при связи с приемными комиссиями университетов, пишем и отправляем письма, звоним от вашего имени.",
                        pricing_plans_plan2_description5_more: "Мониторинг сроков подачи документов и уведомления. Поддержка в чате с ментором 7 дней в неделю.",
                        pricing_plans_plan2_description6_more: "Полная поддержка в процессе подачи заявки, включая заполнение формы и оплату регистрационного сбора ментором.",
                        pricing_plans_plan2_description7_more: "Консультация по оплате обучения и возможным способам оплаты.",
                        pricing_plans_plan2_description8_more: "Предоставляется информация о стоимости проживания. В случае отсутствия мест в общежитии предлагаем 5 вариантов жилья рядом с университетом (Airbnb и другие) и помогаем с бронированием. (Требуется предоплата).<br><br>※ Общежитие не гарантируется.",
                        pricing_plans_plan2_description9_more: "Оказываем поддержку в подаче на визу. Предоставляем список необходимых документов, проверяем их, а также помогаем при задержке визы, включая смену визы в Корее (подготовка документов и запись в иммиграционную службу).",
                        pricing_plans_plan2_description10_more: "Объясняем установку и использование Naver Maps, Kakao Maps и Kakao Taxi.",
                        pricing_plans_plan2_description11_more: "Гид по первой адаптации в Корее: покупка SIM-карты в аэропорту, регистрация иностранца, оформление банковского счета и другие важные советы по жизни.",
                        pricing_plans_plan2_description12_more: "Помощь в знакомстве с другими иностранными студентами: чаты, регулярные встречи и обмен информацией.",
                        pricing_plans_plan2_description13_more: "Предоставляем поддержку талантливым студентам через нашу систему стипендий Koreanasha.",

                        pricing_plans_plan3_subtitle: "Максимальная скидка",
                        pricing_plans_plan3_title: "Премиум план",
                        pricing_plans_plan3_description: "Основано на языковой школе.<br>Для бакалавриата/магистратуры доплата $40.",
                        pricing_plans_plan3_description1: "Первичная консультация (60 минут)",
                        pricing_plans_plan3_description2: "Рекомендация 5 университетов",
                        pricing_plans_plan3_description3: "Подготовка документов",
                        pricing_plans_plan3_description4: "Связь с представителями университетов",
                        pricing_plans_plan3_description5: "Мониторинг и уведомления, поддержка в чате 5 дней в неделю",
                        pricing_plans_plan3_description6: "Предоставление гида по онлайн-заявке",
                        pricing_plans_plan3_description7: "Помощь в оплате обучения и консультация по способам оплаты",
                        pricing_plans_plan3_description8: "Консультация по стоимости и вариантам проживания",
                        pricing_plans_plan3_description9: "Поддержка в подаче на визу (предоставление и проверка документов)",
                        pricing_plans_plan3_description10: "Предоставление информации о транспорте",
                        pricing_plans_plan3_description11: "Гид по жизни в Корее",
                        pricing_plans_plan3_description12: "Поддержка в нетворкинге с другими студентами по прибытии в Корею",
                        pricing_plans_plan3_description13: "Собственная система стипендий",
                        pricing_plans_plan3_btn: "Заявка",
                        pricing_plans_plan3_description1_more: "Предоставляется 60-минутная консультация (аудио/видео). Объясняется весь процесс поступления, обсуждаются вопросы и даются персонализированные рекомендации.",
                        pricing_plans_plan3_description2_more: "Мы подбираем 5 университетов с учетом вашей специальности и предпочтений по месту проживания, после чего выбираем самый подходящий. (При подаче более чем в 2 университета доплата $50 за каждый).",
                        pricing_plans_plan3_description3_more: "Мы предоставляем чек-лист для удобного управления необходимыми документами для поступления в определённый университет. Также даём полезные советы по написанию эссе и других документов, информируем о сроках, стоимости, стипендиях и процессе поступления. Оказываем поддержку в написании мотивационного письма и учебного плана, а также предлагаем одну редакцию этих документов.",
                        pricing_plans_plan3_description4_more: "Оказываем поддержку при связи с приемными комиссиями университетов и звоним от вашего имени.",
                        pricing_plans_plan3_description5_more: "Мониторинг сроков подачи документов и уведомления. Поддержка в чате с ментором 5 дней в неделю.",
                        pricing_plans_plan3_description6_more: "Разъясняем процедуру подачи онлайн-заявки.",
                        pricing_plans_plan3_description7_more: "Консультация по оплате обучения и возможным способам оплаты.",
                        pricing_plans_plan3_description8_more: "Предоставляется информация о стоимости проживания.<br><br>※ Общежитие не гарантируется.",
                        pricing_plans_plan3_description9_more: "Оказываем поддержку в подаче на визу.",
                        pricing_plans_plan3_description10_more: "Объясняем установку и использование Naver Maps, Kakao Maps и Kakao Taxi.",
                        pricing_plans_plan3_description11_more: "Гид по первой адаптации в Корее: покупка SIM-карты в аэропорту, регистрация иностранца, оформление банковского счета и другие важные советы по жизни.",
                        pricing_plans_plan3_description12_more: "Помощь в знакомстве с другими иностранными студентами: чаты, регулярные встречи и обмен информацией.",
                        pricing_plans_plan3_description13_more: "Предоставляем поддержку талантливым студентам через нашу систему стипендий Koreanasha.",
                        ...
                        pricing_plans_plan4_btn: "Заявка",
                        pricing_plans_plan4_description1_more: "-",
                        pricing_plans_plan4_description2_more: "-",
                        pricing_plans_plan4_description3_more: "-",
                        pricing_plans_plan4_description4_more: "-",

                        pricing_plans_plan5_title: "VVIP план",
                        pricing_plans_plan5_subtitle: "Основано на языковой школе.<br>Для бакалавриата/магистратуры доплата $100.",
                        pricing_plans_plan5_description1: "Первичная консультация (без ограничения по времени)",
                        pricing_plans_plan5_description2: "Рекомендация всех подходящих университетов",
                        pricing_plans_plan5_description3: "Подготовка документов",
                        pricing_plans_plan5_description4: "Связь с представителями университетов",
                        pricing_plans_plan5_description5: "Мониторинг и уведомления, поддержка в чате и звонки 7 дней в неделю",
                        pricing_plans_plan5_description6: "Полная поддержка в процессе подачи онлайн-заявки",
                        pricing_plans_plan5_description7: "Оплата обучения от имени студента",
                        pricing_plans_plan5_description8: "Консультация по стоимости и вариантам проживания",
                        pricing_plans_plan5_description9: "Поддержка в подаче на визу",
                        pricing_plans_plan5_description10: "Предоставление информации о транспорте",
                        pricing_plans_plan5_description11: "Гид по жизни в Корее",
                        pricing_plans_plan5_description12: "Поддержка в нетворкинге с другими студентами по прибытии в Корею",
                        pricing_plans_plan5_description13: "Собственная система стипендий",
                        ...
                        pricing_plans_plan5_description2_more: "Рекомендуем все возможные университеты, учитывая специальность и предпочтительное место проживания, а затем выбираем наиболее подходящий. (При подаче более чем в 2 университета доплата $50 за каждый).",
                        pricing_plans_plan5_description3_more: "Мы предоставляем чек-лист для удобного управления необходимыми документами для поступления в определённый университет. Также предлагаем полезные советы и примеры для написания эссе и других документов, информируем о сроках, стоимости, стипендиях и процессе поступления. Оказываем поддержку в составлении структуры мотивационного письма и учебного плана (грамматическая и лексическая коррекция, неограниченное количество редакций).",
                        pricing_plans_plan5_description4_more: "Поддержка в общении с приемными комиссиями университетов, создание студенческого email-аккаунта и ведение переписки от имени студента, а также телефонные запросы.",
                        pricing_plans_plan5_description5_more: "Мониторинг сроков подачи документов и уведомления. Поддержка в чате и звонки 7 дней в неделю. (Гарантия ответа в течение 1 часа).",
                        pricing_plans_plan5_description6_more: "Полная поддержка в процессе подачи заявки, включая заполнение формы и оплату регистрационного сбора ментором.",
                        pricing_plans_plan5_description7_more: "Оплата обучения от имени студента (необходимо предварительное перечисление средств на счет ментора).",
                        pricing_plans_plan5_description8_more: "Предоставляется информация о стоимости проживания. В случае отсутствия мест в общежитии предлагаем неограниченное количество вариантов жилья рядом с университетом (Airbnb и другие) и помогаем с бронированием. (Требуется предоплата).<br><br>※ Общежитие не гарантируется.",
                        pricing_plans_plan5_description9_more: "Оказываем поддержку в подаче на визу. Предоставляем список необходимых документов, проверяем их, а также помогаем при задержке визы, включая смену визы в Корее (подготовка документов и запись в иммиграционную службу).",
                        pricing_plans_plan5_description10_more: "Объясняем установку и использование Naver Maps, Kakao Maps и Kakao Taxi.",
                        pricing_plans_plan5_description11_more: "Гид по первой адаптации в Корее: покупка SIM-карты в аэропорту, регистрация иностранца, оформление банковского счета и другие важные советы по жизни. Также предоставляется консультация по адаптации в течение 3 месяцев после поступления.",
                        pricing_plans_plan5_description12_more: "Помощь в знакомстве с другими иностранными студентами: чаты, регулярные встречи и обмен информацией.",
                        pricing_plans_plan5_description13_more: "Предоставляем поддержку талантливым студентам через нашу систему стипендий Koreanasha.",

                        pricing_plans_plan6_title: "Трансфер из аэропорта и тур по кампусу",
                        pricing_plans_plan6_subtitle: "Только для кампусов в Сеуле",
                        pricing_plans_plan6_description1: "Трансфер из аэропорта",
                        pricing_plans_plan6_description2: "Тур по кампусу",
                        pricing_plans_plan6_btn: "Заявка",
                        pricing_plans_plan6_description1_more: "После прибытия в аэропорт мы организуем трансфер до кампуса. (Оплата за такси не включена)",
                        pricing_plans_plan6_description2_more: "Проводится экскурсия по кампусу, включая известные места.",

                        pricing_plans_plan7_title: "Поиск жилья для самостоятельного проживания",
                        pricing_plans_plan7_subtitle: "Только для Сеула и провинции Кёнгги",
                        pricing_plans_plan7_description1: "Поиск объявлений онлайн",
                        pricing_plans_plan7_description2: "Поиск вариантов на месте",
                        pricing_plans_plan7_btn: "Заявка",
                        pricing_plans_plan7_description1_more: "Мы подбираем наиболее подходящие варианты жилья по цене и внешнему виду и отправляем вам.",
                        pricing_plans_plan7_description2_more: "Мы помогаем вам найти жильё на месте через русскоязычных партнеров.",
                        ...
                        modal_title: "Заполните заявку и получите консультацию по корейским университетам.",
